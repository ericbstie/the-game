...
- Bound its scope, not its calendar: one question, and the smallest build that answers it. A prototype that outgrows that has quietly become production code without the care production needs.
